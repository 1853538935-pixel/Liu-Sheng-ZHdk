...
<body> 
    ...
    <script> 
        ...
        async function renderScene() {
            ...
            // 图片确定在缓存后，再启动打字机
            typeWriter(document.getElementById('dialogue-text'), state.currentHTML, 40);
        ...
        async function nextStep() {
            ...
            if (state.typing) {
                ...
                document.getElementById('dialogue-text').innerHTML = state.currentHTML;
                state.typing = false;
                return;
            }
        ...
        // ... 其余逻辑（triggerEnding, typeWriter, runIntro等）保持不变 ...
        // 注意：将结局处理逻辑也加上异步支持
